...
const Login = () => {
    ...
    const handleSubmit = async (values) => {
        try {
            const res = await axios.post("https://apii-deploy.onrender.com/auth/login", {
                email: values.email,
    ...
    const handleSignUp = async (values) => {
        try {
            const response = await axios.post('https://apii-deploy.onrender.com/auth/register', values);
