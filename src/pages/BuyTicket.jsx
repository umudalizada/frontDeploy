...
const BuyTicket = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const response = await axios.get('https://apii-deploy.onrender.com/api/tickets');
  ...
  const handleSeansChange = async (e) => {
    ...
    if (category && event && selectedSeans) {
      try {
        const response = await axios.get('https://apii-deploy.onrender.com/api/reserv', {
  ...
  const handlePaymentSuccess = async () => {
    ...
    try {
      await axios.post('https://apii-deploy.onrender.com/api/reserv', newReservation);

      // Update user orders
      const updatedOrders = [...(user.orders || []), newReservation];
      await axios.patch(`https://apii-deploy.onrender.com/api/users/${user._id}`, { orders: updatedOrders });
